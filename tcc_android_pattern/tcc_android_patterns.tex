...
the most varied purposes. To meet this demand is necessary to develop quality
and high productivity applications . However , for the case of small
applications there is little concern with the architecture of the solution .
The patterns are widespread in the community focused on the use of components and
development of man-machine interaction. This paper aims to present the
...
iteratively applied using the process and incremental refactoring collecting
quality metrics of code to do a quantitative analysis .
The results show that the application of standard increased the cohesion of the
code, however, with a small increase in complexity due to the inclusion of new
