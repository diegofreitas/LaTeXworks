...
java -jar ckjm-1.9.jar ImplementacaoDeClasse.class
...
ImplementacaoDeClasse.class 4 0 0 16 35 0 0 3
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.53,angle=90]{img/classes_group_baseline}
	\caption{Diagrama de pacotes do aplicativo de contatos} 
