%TODO 3 - seção 3.4.1 - Vc cita que o WMC recomenda q seus valores sejam baixos.
% Porém, na coleta os valores aumentaram... explicar claramente o q ocorreu. Como alguem que nao ta consumindo
% codigos de aplicacoes diariamente, senti que nao eh trivial entender as causas
% q justificam tal comportamento. Isso serve para todos os indicadores. Vc
% precisa determinar:  
%1o) qual o cenario ideal para metrica;
%2o) qual o comportamento atual; 
...
Apoós cada iteração de refatoração, as Views delegam responsabilidades para o
Presenter por meio de chamada de métodos, além disso, o Presenter interage com a
View da mesma forma para atualiza-la. A quantidade de chamada de métodos
aumentou e isso se refletiu na métrica RFC.
...
siginificativa na métrica LCOM. Isto indica que a coesão do código melhorou após
cada iteração.
