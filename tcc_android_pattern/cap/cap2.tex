...
\begin{figure}[htb]
	\label{fig:pic_rfc}
	\caption{Exemplo de avaliação da métrica RFC}
	\begin{center}
...
\begin{figure}[htb]
	\label{fig:pic_cbo}
	\caption{Exemplo de avaliação da métrica CBO}
	\begin{center}
...
\begin{figure}[htb]
	...
	\caption{Exemplo  de avaliação da métrica LCOM}
	\begin{center}
...
\begin{figure}[htb]
	\label{fig:pic_dit}
	\caption{Exemplo de avaliação da métrica DIT}
	\begin{center}
...
\begin{figure}[htb]
	\label{fig:pic_noc}
	\caption{Exemplo de avaliação da métrica NOC}
	\begin{center}
...
\begin{figure}[htb]
	\label{fig:pic_wmc}
	\caption{Exemplo de avaliação da métrica WMC}
	\begin{center}
...
\begin{figure}[htb]
	\label{mvc}
	\caption{Representação dos componentes do MVC}
	\begin{center}
...
\begin{figure}[htb]
	...
	\caption{MVP - Supervising Controller}
	\begin{center}
