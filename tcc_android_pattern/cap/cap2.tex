...
A View é composta por vários objetos com a ressponsabilidade em comum de
...
permitindo que variem independentemente dos clientees que o usam''(tradução
...
as interações entre o Controller e o Model. O padrão Facade uma provê
