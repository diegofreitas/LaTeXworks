...
%TODO - Diego, o parag a seguir eh estranho, pois eh um dado `futuro' de 2013.
% entendeu? previsao para 2013, sendo q estamos em 2014...
Segundo o IDC,  é esperado um crescimento de 32.7\% na produção de dispositivos móveis em 2013 \cite{idc:a}. O sistema
operacional Android é o líder de mercado dominando 75\% desse universo com mais de 162 milhões de
smartphones produzidos e embarcados com android\cite{idc:b}. Baseado nesses
dados é possível concluir que existe uma demanda latente no desenvolvimento de novos 
aplicativos que agreguem valor à esses aparelhos.
